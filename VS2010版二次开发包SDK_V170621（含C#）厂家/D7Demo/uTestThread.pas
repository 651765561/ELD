...
begin
  ...
  begin
    ...
    //AddText(K, 0, 0, 64, 64, 1, 0, PChar(FormatDateTime('nnsszzz', Now)), 'ËÎÌו', 12, RGB(255,255,0), WFS_BOLD, 0, 0, 1, 5, 0, 5, 0, 5, 10000);
    //AddPicture(K, 0, 0, 64, 64, 1, 0, PChar(ExtractFilePath(Application.ExeName) + 'Test.bmp'), 0, 1, 5, 0, 5, 0, 5, 10000);
    AddDateTime(K, 0, 0, 64, 32, 1, 0, 'ËÎÌו', 12, 255, 0, 0, 0, 0, 0, '#y:#n:#s');
