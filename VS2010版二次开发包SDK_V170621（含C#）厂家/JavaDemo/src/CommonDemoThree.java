...
public class CommonDemoThree {
	...
	private static final int the_color_mode = LedControl.COLOR_MODE_THREE;
	...
	public static void demo_send() {
		...
		LedControl.INSTANCE.SetSignalOrder(1);
		...
		LedControl.INSTANCE.AddLeafEx((short) k, 3000,
				(short) LedControl.MODE_WAIT_CHILD, 0xFF0000);
		 ...
		 * LedControl.INSTANCE.AddLeaf((short)k, 3000,
		 * (short)LedControl.MODE_WAIT_CHILD);
		 * LedControl.INSTANCE.AddPicture((short)k, 0, 0, 96, 24, 1, 0,
	...
	public static void demo_rotate_send() {
		...
		// width 显示屏宽度(旋转后)
		// height 显示屏高度(旋转后)
		LedControl.INSTANCE.SetRotate(1, 64, 256);
