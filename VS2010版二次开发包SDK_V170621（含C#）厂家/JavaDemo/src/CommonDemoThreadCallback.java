...
public class CommonDemoThreadCallback {
	...
	public interface LedControl extends Library {
		...
		//procedure LED_SetMultiModeCallBack(ACallBack: TMultiModeCallBack); stdcall;
		void LED_SetMultiModeCallBack(INotifyCallBack.CallbackFunctionImp notify_callback_proc);
		...
		int LED_UDP_SenderParamExA(int index, int localport, String host,
				int remoteport, int address, int notifymode, int wmhandle,
				int wmmessage, int wmlparam, int txtimeo, int txrepeat);
		...
		int LED_SetPowerSchedule2(int senderparam_index, int enabled, int mode,
				String AOpenT0, String ACloseT0, String AOpenT1, String ACloseT1, 
				String AOpenT2, String ACloseT2, String AOpenT3, String ACloseT3, 
				String AOpenT4,	String ACloseT4, String AOpenT5, String ACloseT5,
				String AOpenT6, String ACloseT6, String AOpenT7, String ACloseT7, 
				String AOpenT8, String ACloseT8, String AOpenT9, String ACloseT9, 
				String AOpenT10, String ACloseT10, String AOpenT11, String ACloseT11,
				String AOpenT12, String ACloseT12, String AOpenT13, String ACloseT13, 
				String AOpenT14, String ACloseT14, String AOpenT15, String ACloseT15, 
				String AOpenT16, String ACloseT16, String AOpenT17, String ACloseT17,
				String AOpenT18, String ACloseT18, String AOpenT19,	String ACloseT19, 
				String AOpenT20, String ACloseT20);
		...
		//procedure LED_Cache_SetBoardParam_ReportTime(Value: Integer); stdcall;
		void LED_Cache_SetBoardParam_ReportTime(int value);

		//procedure LED_Cache_SetBoardParam_ServerPort(Value: Integer); stdcall;
		void LED_Cache_SetBoardParam_ServerPort(int value);

		//procedure LED_Cache_SetBoardParam_ReportEnabled(Value: Integer); stdcall;
		...
		int AddDesktop(short num, int left, int top, int width, int height,
				int transparent, int border, int src_left, int src_top, int src_width, int src_height, int alignment,
				int inmethod, int inspeed, int outmethod, int outspeed,
				int stopmethod, int stopspeed, int stoptime); // stoptime单位为毫秒
	...
	public static void demo_get_power() {
		...
		while (i<500)
		{
  		  ...
  		  //ip="192.168.2.99";
		  dev = LedControl.INSTANCE.LED_UDP_SenderParamExA(0, demo_local_port,
					ip, 6666, 0, 8, 0, 0, 0, 80, 3);
	...
	public static void demo_power_on() {
		int dev = LedControl.INSTANCE.LED_UDP_SenderParamExA(0, demo_local_port,
				demo_host, 6666, 0, 8, 0, 0, 0, 80, 3);
	...
	public static void demo_power_schedule() {
		int dev = LedControl.INSTANCE.LED_UDP_SenderParamExA(0, demo_local_port,
				demo_host, 6666, 0, 8, 0, 0, 0, 80, 3);
		int r = LedControl.INSTANCE.LED_SetPowerSchedule2(dev, 1, 0, 
				"08:00:00", "12:00:00", "13:00:00", "17:00:00", "19:00:00", "21:00:00",  //周日
				"08:00:00", "12:00:00", "13:00:00", "17:00:00", "19:00:00", "21:00:00",  //周一 
				"08:00:00", "12:00:00", "13:00:00", "17:00:00", "19:00:00", "21:00:00",  //周二
				"08:00:00", "12:00:00", "13:00:00", "17:00:00", "19:00:00", "21:00:00",  //周三 
				"08:00:00", "12:00:00", "13:00:00", "17:00:00", "19:00:00", "21:00:00",  //周四 
				"08:00:00", "12:00:00", "13:00:00", "17:00:00", "19:00:00", "21:00:00",  //周五 
				"08:00:00", "12:00:00", "13:00:00", "17:00:00", "19:00:00", "21:00:00"   //周六
				);
		parse(r);
	}
	...
	public static void demo_set_wan_param() {
		int dev = LedControl.INSTANCE.LED_UDP_SenderParam(0, demo_local_port,
				demo_host, 6666, 0, 8, 0, 0);
		int r = LedControl.INSTANCE.LED_Cache_GetBoardParam2(dev);
		if (r >= 0) {
			LedControl.INSTANCE.LED_Cache_SetBoardParam_ServerIP("192.168.1.100");
	...
	public static void demo_send() {
		...
		LedControl.INSTANCE.AddLeaf((short) k, 3000,
				(short) LedControl.MODE_WAIT_CHILD);
		LedControl.INSTANCE.AddDesktop((short) k, 0, 0, 64, 32, 1, 0,
				100, 100, 64, 32, 0, 1, 5, 2, 5, 0, 5, 3000); // stoptime单位为毫秒
	...
	public static void demo_send_table() {
		...
		LedControl.INSTANCE.AddLeaf((short) k, 3000,
				(short) LedControl.MODE_WAIT_CHILD);
		LedControl.INSTANCE.AddText((short) k, 0, 4, 180, 16, 1, 0,
				"在场总人数：174人", "宋体", 12, 0xFFFF, 0x0, 1, 1, 1, 5, 2,
				5, 0, 5, 3000); // stoptime单位为毫秒
		LedControl.INSTANCE.AddTable((short) k, 0, 24, 320, 192, 1, "C:\\Table2.ini",
				"111|111|111|111\r\n222|222|222|222\r\n333|333|333|333\r\n444|444|444|444\r\n555|555|555|555", 
	...
	public static void demo_chapter_schedule() {
		...
		// 注意，此播放计划模式下，week参数必须置0
		 LedControl.INSTANCE.AddChapterEx2((short)k, 30000,
		 (short)LedControl.MODE_WAIT_CHILD, (short)0, (short)2, (short)0,
		 "2014-09-18 08:00:00", "2014-12-01 17:54:00");
	...
	public static void main(String[] args) {
		...
		INotifyCallBack.CallbackFunctionImp led_notify_callback = new INotifyCallBack.CallbackFunctionImp();	
		LedControl.INSTANCE.LED_SetMultiModeCallBack(led_notify_callback);
...
interface INotifyCallBack extends StdCallLibrary {		
	public interface CallbackFunction extends StdCallCallback {
		void CALLBACK_FUN(int notifyindex, int lparam);	
	}		
	public class CallbackFunctionImp implements CallbackFunction {
		@Override
		public void CALLBACK_FUN(int notifyindex, int lparam) {
			// TODO Auto-generated method stub
			int notify = CommonDemoThreadCallback.LedControl.INSTANCE.LED_GetNotifyParam_Notify(notifyindex);
			if (notify == CommonDemoThreadCallback.LedControl.LM_TIMEOUT) {
				System.out.println("发送节目或者执行命令超时"+CommonDemoThreadCallback.LedControl.INSTANCE.LED_GetNotifyParam_Host(notifyindex));
				CommonDemoThreadCallback.send_status = 0;
			} else if (notify == CommonDemoThreadCallback.LedControl.LM_TX_COMPLETE) {
				int result = CommonDemoThreadCallback.LedControl.INSTANCE.LED_GetNotifyParam_Result(notifyindex);
				if (result == CommonDemoThreadCallback.LedControl.RESULT_FLASH) {
					System.out.println("发送节目或者执行命令完成，正在写入Flash");
				} else {
					System.out.println("发送节目或者执行命令完成");
					CommonDemoThreadCallback.send_status = 0;
				}
			} else if (notify == CommonDemoThreadCallback.LedControl.LM_RESPOND) {
				int command = CommonDemoThreadCallback.LedControl.INSTANCE.LED_GetNotifyParam_Command(notifyindex);
				if (command == CommonDemoThreadCallback.LedControl.PKC_GET_POWER) {
					int status = CommonDemoThreadCallback.LedControl.INSTANCE
							.LED_GetNotifyParam_Status(notifyindex);
					if (status == 1) {
					...
					CommonDemoThreadCallback.send_status = 0;
				} else if (command == CommonDemoThreadCallback.LedControl.PKC_SET_POWER) {
					int status = CommonDemoThreadCallback.LedControl.INSTANCE
							.LED_GetNotifyParam_Status(notifyindex);
					if (status == 1) {
					...
					CommonDemoThreadCallback.send_status = 0;
				} else if (command == CommonDemoThreadCallback.LedControl.PKC_GET_BRIGHT) {
					int status = CommonDemoThreadCallback.LedControl.INSTANCE
							.LED_GetNotifyParam_Status(notifyindex);
					System.out.println("读取亮度完成，当前亮度为" + status);
					CommonDemoThreadCallback.send_status = 0;
				} else if (command == CommonDemoThreadCallback.LedControl.PKC_SET_BRIGHT) {
					int status = CommonDemoThreadCallback.LedControl.INSTANCE
							.LED_GetNotifyParam_Status(notifyindex);
					System.out.println("设置亮度完成，当前亮度为" + status);
					CommonDemoThreadCallback.send_status = 0;
				} else if (command == CommonDemoThreadCallback.LedControl.PKC_ADJUST_TIME) {
					System.out.println("校正时间完成");
					CommonDemoThreadCallback.send_status = 0;
				} else if (command == CommonDemoThreadCallback.LedControl.PKC_SET_EXSTRING) {
					System.out.println("设置外部变量字符串完成");
					CommonDemoThreadCallback.send_status = 0;
				}
			} else if (notify == CommonDemoThreadCallback.LedControl.LM_NOTIFY) {
				int result = CommonDemoThreadCallback.LedControl.INSTANCE.LED_GetNotifyParam_Result(notifyindex);
				if (result == CommonDemoThreadCallback.LedControl.NOTIFY_ROOT_DOWNLOAD) {
					System.out.println("下载节目写入Flash完成");
				} else if (result == CommonDemoThreadCallback.LedControl.NOTIFY_GET_PLAY_BUFFER) {
					CommonDemoThreadCallback.LedControl.INSTANCE.LED_GetNotifyParam_Buffer(
							"preview.dat", notifyindex);
					CommonDemoThreadCallback.LedControl.INSTANCE.LED_PreviewFile_Export("SimuLED.exe",
							320, 192, 1, "C:\\preview.bmp");
					CommonDemoThreadCallback.LedControl.INSTANCE.LED_PreviewFileEx("SimuLED.exe", 320,
							192, "preview.dat");
					System.out.println("读取控制卡内播放内容完成");
					CommonDemoThreadCallback.send_status = 0;
				} else if (result == CommonDemoThreadCallback.LedControl.NOTIFY_SET_PARAM) {
